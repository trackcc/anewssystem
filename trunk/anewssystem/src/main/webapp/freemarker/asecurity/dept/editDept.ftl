...
<html>
  <head>
    ...
    <@validator.javascript formName="dept" staticJavascript="false"/>
  </head>
  <body>
<div class="pageTitle">Dept信息</div>
<#if dept??>
  <@m.showError "dept.*"/>
</#if>
...
<form name="dept"
    ...
    action="${ctx}/dept/${action}.htm"
    method="post" onsubmit="return validateDept(this)">
  <@jodd.form beans="dept" scopes="request">
      <input type="hidden" name="id">
    <table class="border" width="90%" cellSpacing="0" cellPadding="2" align="center">
    <tr>
      <td class="left" width="20%"><@spring.messageText code="dept.dept" text="dept"/>:</td>
      <td class="right">
    ...
    <tr>
      <td class="left" width="20%"><@spring.messageText code="dept.name" text="name"/>:</td>
      <td class="right">
    ...
    <tr>
      <td class="left" width="20%"><@spring.messageText code="dept.descn" text="descn"/>:</td>
      <td class="right">
