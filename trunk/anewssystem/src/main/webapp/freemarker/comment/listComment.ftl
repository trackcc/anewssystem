...
<div id="operationDiv">
  <span class="operations"><a href="${ctx}/index.jsp">返回首页</a>&nbsp;
    ...
    &nbsp;<A href="${ctx}/comment/create.htm">增加</A>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <img src="${ctx}/images/icon/16x16/delete.gif" align="top">
    &nbsp;<A href="javascript:batch_do('删除Comment','${ctx}/comment/removeAll.htm?token');">删除</A>
  </span>
</div>
<div id="tableDiv">
  <#include "/include/messages.ftl"/>
  <@ec.table items="page" var="item"
            action="${ctx}/comment/list.htm"
            retrieveRowsCallback="limit"
            sortRowsCallback="limit"
            rowsDisplayed="15"
            autoIncludeParameters="false">
    <@ec.exportXls fileName="CommentList.xls" tooltip="导出 Excel"/>
    <@ec.row>
      <@ec.column property="rowcount" cell="rowCount" title="序号" sortable="false"/>
      <@ec.column property="news" title="comment.news"/>
      <@ec.column property="name" title="comment.name"/>
      <@ec.column property="content" title="comment.content"/>
      <@ec.column property="username" title="comment.username"/>
      <@ec.column property="updateDate" title="comment.updateDate"/>
      <@ec.column property="status" title="comment.status"/>
      <@ec.column property="ip" title="comment.ip"/>
      <@ec.column property="edit" title="修改" sortable="false" viewsAllowed="html" width="40">
        <a href="${ctx}/comment/edit.htm?id=${item.id}">
