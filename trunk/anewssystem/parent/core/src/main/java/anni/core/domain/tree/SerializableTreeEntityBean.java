...
import anni.core.domain.SerializableNamedEntityBean;


/**
 * id是Serializable的Tree类实现.
 *
 * @author Lingo
 * @since 2007-06-06
 ...
 */
@MappedSuperclass
public class SerializableTreeEntityBean<T extends SerializableTreeEntityBean>
    extends SerializableNamedEntityBean implements TreeEntityBean<T> {
    /** * parent. */
