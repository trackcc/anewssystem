...
public class IBatisEntityDao<T> extends IBatisGenericDao {
    ...
    protected Object getPrimaryKeyValue(Object o)
        ...
        //2007-3-29
        //fix PropertyUtils.getProperty(entityClass.newInstance(), getPrimaryKeyName()) always is null		    
        return PropertyUtils.getProperty(entityClass.cast(o),
            getPrimaryKeyName());
    }
    ...
    public Page pagedQuery(Object parameterObject, int pageNo, int pageSize) {
        return pagedQuery(getEntityClass(), parameterObject, pageNo,
            pageSize);
    }
