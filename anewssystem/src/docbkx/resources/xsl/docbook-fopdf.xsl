                ...
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            ...
                            <fo:block font-family="simsun" font-size="32pt"
                                      font-weight="bold" padding-before="60mm">
                                <xsl:value-of select="bookinfo/title"/>
                            </fo:block>
                            <fo:block font-family="simsun" font-size="24pt" padding-before="5mm">
                                <xsl:value-of select="bookinfo/subtitle"/>
                            </fo:block>
                            <fo:block font-family="simsun" font-size="16pt" padding="5mm">
                    ...
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <fo:block font-family="simsun" font-size="14pt" padding-before="10mm">
                    ...
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            ...
                            <fo:block font-family="simsun" font-size="10pt" padding="5mm">
