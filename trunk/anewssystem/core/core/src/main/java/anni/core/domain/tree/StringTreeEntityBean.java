...
import anni.core.domain.StringNamedEntityBean;
 ...
 */
@MappedSuperclass
public class StringTreeEntityBean<T extends StringTreeEntityBean>
    extends StringNamedEntityBean implements TreeEntityBean<T> {
    /** * parent. */
