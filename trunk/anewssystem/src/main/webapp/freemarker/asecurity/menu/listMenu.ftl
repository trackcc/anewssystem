...
<div id="operationDiv">
  <span class="operations"><a href="${ctx}/index.jsp">返回首页</a>&nbsp;
    ...
    &nbsp;<A href="${ctx}/menu/create.htm">增加</A>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <img src="${ctx}/images/icon/16x16/delete.gif" align="top">
    &nbsp;<A href="javascript:batch_do('删除Menu','${ctx}/menu/removeAll.htm?token');">删除</A>
  </span>
</div>
<div id="tableDiv">
  <#include "/include/messages.ftl"/>
  <@ec.table items="page" var="item"
            action="${ctx}/menu/list.htm"
            retrieveRowsCallback="limit"
            sortRowsCallback="limit"
            rowsDisplayed="15"
            autoIncludeParameters="false">
    <@ec.exportXls fileName="MenuList.xls" tooltip="导出 Excel"/>
    <@ec.row>
      <@ec.column property="rowcount" cell="rowCount" title="序号" sortable="false"/>
      <@ec.column property="parent.name" title="menu.parent"/>
      <@ec.column property="name" title="menu.name"/>
      <@ec.column property="seq" title="menu.seq"/>
      <@ec.column property="title" title="menu.title"/>
      <@ec.column property="tip" title="menu.tip"/>
      <@ec.column property="image" title="menu.image"/>
      <@ec.column property="forward" title="menu.forward"/>
      <@ec.column property="target" title="menu.target"/>
      <@ec.column property="descn" title="menu.descn"/>
      <@ec.column property="edit" title="修改" sortable="false" viewsAllowed="html" width="40">
        <a href="${ctx}/menu/edit.htm?id=${item.id}">
